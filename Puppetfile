...
mod 'voxpupuli/corosync',
    :git => 'https://github.com/voxpupuli/puppet-corosync.git',
    :ref => 'v9.1.0'
...
mod 'voxpupuli/drbd',
    :git => 'https://github.com/voxpupuli/puppet-drbd.git',
    :ref => 'v1.0.0'

mod 'voxpupuli/mongodb',
    :git => 'https://github.com/voxpupuli/puppet-mongodb.git',
    :ref => 'v7.0.0'

mod 'dhoppe/fail2ban',
    :git => "https://github.com/dhoppe/puppet-fail2ban.git",
    :ref => 'v5.0.2'
...
mod 'alexharvey/firewall_multi',
    :git => "https://github.com/alexharv074/puppet-firewall_multi.git",
    :ref => '8.0.1'
...
mod 'puppetlabs/mount_core',
    :git => "https://github.com/puppetlabs/puppetlabs-mount_core.git",
    :ref => 'v1.3.0'
...
mod 'voxpupuli/epel',
    :git => 'https://github.com/voxpupuli/puppet-epel.git',
    :ref => 'v5.0.0'

mod 'voxpupuli/nsswitch',
    :git => 'https://github.com/voxpupuli/puppet-nsswitch.git',
    :ref => 'v3.2.0'
...
mod 'tpdownes/sysctl',
    :git => 'https://github.com/tpdownes/puppet-sysctl.git',
    :ref => '2.1.0'
...
mod 'loomsen/rsnapshot',
    :git => 'https://github.com/loomsen/puppet-rsnapshot.git',
    :ref => '1.2.4'
...
mod 'voxpupuli/wireguard',
    :git => 'https://github.com/voxpupuli/puppet-wireguard.git',
    :ref => 'v4.1.0'
...
mod 'ULHPC/slurm',
    :git => 'https://github.com/ULHPC/puppet-slurm.git',
    :ref => 'v1.5.3'

mod 'bodgit/rngd',
    :git => 'https://github.com/bodgit/puppet-rngd.git',
    :ref => 'v3.0.1'
